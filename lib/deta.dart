                        ...
                        child: Container(
                          ...
                          child:Column(
                              ...
                              children:[
                                ...
                                Text(
                                    "Optimum (°C): 25-35",style: TextStyle(
                                    fontSize:15,
                                    color: color.AppColor.hpt)
                                ),
                                Text(
                        ...
                        child: Container(
                          ...
                          child:Column(
                              ...
                              children:[
                                ...
                                Text(
                                    "Optimum (°C): 20-30",style: TextStyle(
                                    fontSize:15,
                                    color: color.AppColor.hpt)
                                ),
                                Text(
                                    "Rainfall : 350-600",style: TextStyle(
                                    fontSize:15,
                                    color: color.AppColor.hpt)
                                ),
                                Text(
                        ...
                        child: Container(
                          ...
                          child:Column(
                              ...
                              children:[
                                ...
                                Text(
                                    "Rainfall : 500-800",style: TextStyle(
                                    fontSize:15,
                                    color: color.AppColor.hpt)
                                ),
                                Text(
